export const PAPAYA_ABI = [
  {
    inputs: [
      { internalType: "address", name: "CHAIN_PRICE_FEED_", type: "address" },
      { internalType: "address", name: "TOKEN_PRICE_FEED_", type: "address" },
  ...
  { inputs: [], name: "ExcessOfRate", type: "error" },
  { inputs: [], name: "ExcessOfSubscriptions", type: "error" },
  { inputs: [], name: "FailedInnerCall", type: "error" },
  { inputs: [], name: "IndexOutOfBounds", type: "error" },
  { inputs: [], name: "InsufficialBalance", type: "error" },
  {
    inputs: [{ internalType: "uint256", name: "projectId", type: "uint256" }],
  ...
  { inputs: [], name: "NotLegal", type: "error" },
  ...
  { inputs: [], name: "ReduceTheAmount", type: "error" },
  {
  ...
  { inputs: [], name: "TopUpBalance", type: "error" },
  { inputs: [], name: "WrongNonce", type: "error" },
  { inputs: [], name: "WrongNonceType", type: "error" },
  { inputs: [], name: "WrongPercent", type: "error" },
  { inputs: [], name: "WrongRelayer", type: "error" },
  { inputs: [], name: "WrongSignature", type: "error" },
  { inputs: [], name: "WrongToken", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256[]", name: "encodedRates", type: "uint256[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint16", name: "projectFee", type: "uint16" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "isPermit2", type: "bool" },
    ],
    name: "deposit",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint96", name: "subscriptionRate", type: "uint96" },
      { internalType: "uint256", name: "projectId", type: "uint256" },
    ],
    name: "subscribe",
    outputs: [],
  ...
  {
    inputs: [{ internalType: "uint32", name: "advance", type: "uint32" }],
  ...
  },
  {
    inputs: [
      { internalType: "bytes4", name: "selector", type: "bytes4" },
      { internalType: "uint32", name: "advance", type: "uint32" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "int256", name: "incomeRate", type: "int256" },
      { internalType: "int256", name: "outgoingRate", type: "int256" },
